...
describe("PlatformVMAPI", (): void => {
  ...
  test("exportDIONE", async (): Promise<void> => {
    ...
    const result: Promise<string | ErrorResponseObject> = api.exportDIONE(
      username,
      password,
      amount,
      to
  ...
  test("importDIONE", async (): Promise<void> => {
    ...
    const txID = "valid"
    const result: Promise<string | ErrorResponseObject> = api.importDIONE(
      username,
      password,
      to,
      blockchainID
  ...
  describe("Transactions", (): void => {
    ...
    */
    ...
    test("buildAddValidatorTx sort StakeableLockOuts 3", async (): Promise<void> => {
      ...
      // The 2nd has a lesser stakeablelocktime and a greater amount of DIONE.
      // The 3rd has a greater stakeablelocktime and a lesser amount of DIONE.
      //
