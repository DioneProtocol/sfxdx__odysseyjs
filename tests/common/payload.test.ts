...
describe("Payload", (): void => {
  ...
  const testTable: any[] = [
    ...
    ["XCHAINADDR", "A-" + bech, cb58buf],
    ["PCHAINADDR", "O-" + bech, cb58buf],
    ["CCHAINADDR", "D-" + bech, cb58buf],
