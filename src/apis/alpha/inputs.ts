...
export const SelectInputClass = (inputid: number, ...args: any[]): Input => {
  if (
    inputid === ALPHAConstants.SECPINPUTID ||
    inputid === ALPHAConstants.SECPINPUTID_CODECONE
  ) {
...
export class SECPTransferInput extends AmountInput {
  ...
  protected _typeID =
    this._codecID === 0
      ? ALPHAConstants.SECPINPUTID
      : ALPHAConstants.SECPINPUTID_CODECONE
