...
export const SelectTxClass = (txtype: number, ...args: any[]): BaseTx => {
  if (txtype === ALPHAConstants.BASETX) {
    return new BaseTx(...args)
  } else if (txtype === ALPHAConstants.CREATEASSETTX) {
    return new CreateAssetTx(...args)
  } else if (txtype === ALPHAConstants.OPERATIONTX) {
    return new OperationTx(...args)
  } else if (txtype === ALPHAConstants.IMPORTTX) {
    return new ImportTx(...args)
  } else if (txtype === ALPHAConstants.EXPORTTX) {
