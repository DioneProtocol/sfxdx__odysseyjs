...
export class ImportTx extends BaseTx {
  ...
  protected _typeID = OmegaVMConstants.IMPORTTX
   ...
   * @param sourceChain Optiona chainid for the source inputs to import. Default omega chainid.
