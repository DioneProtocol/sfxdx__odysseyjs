...
import { ExportTx } from "../omegavm/exporttx"
import { DefaultNetworkID, Defaults } from "../../utils/constants"
import { ImportTx } from "../omegavm/importtx"
import { BaseTx } from "../omegavm/basetx"
import {
...
import { AddSubnetValidatorTx } from "../omegavm/addsubnetvalidatortx"
...
export class UTXO extends StandardUTXO {
  ...
  create(
    codecID: number = OmegaVMConstants.LATESTCODEC,
  ...
  buildExportTx = (
    ...
    if (typeof destinationChain === "undefined") {
      destinationChain = bintools.cb58Decode(
        Defaults.network[`${networkID}`].A["blockchainID"]
      )
    }
