...
export const SelectOutputClass = (outputid: number, ...args: any[]): Output => {
  if (outputid == OmegaVMConstants.SECPXFEROUTPUTID) {
    return new SECPTransferOutput(...args)
  } else if (outputid == OmegaVMConstants.SECPOWNEROUTPUTID) {
    return new SECPOwnerOutput(...args)
  } else if (outputid == OmegaVMConstants.STAKEABLELOCKOUTID) {
...
export class SECPTransferOutput extends AmountOutput {
  ...
  protected _typeID = OmegaVMConstants.SECPXFEROUTPUTID
...
export class StakeableLockOut extends AmountOutput {
  ...
  protected _typeID = OmegaVMConstants.STAKEABLELOCKOUTID
...
export class SECPOwnerOutput extends Output {
  ...
  protected _typeID = OmegaVMConstants.SECPOWNEROUTPUTID
