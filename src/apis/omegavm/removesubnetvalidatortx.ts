 ...
 * @module API-OmegaVM-RemoveSubnetValidatorTx
 */
...
export class RemoveSubnetValidatorTx extends BaseTx {
  ...
  protected _typeID = OmegaVMConstants.REMOVESUBNETVALIDATORTX
   ...
   */
  getTxType(): number {
    return OmegaVMConstants.REMOVESUBNETVALIDATORTX
  }
  ...
  getCredentialID(): number {
    return OmegaVMConstants.SECPCREDENTIAL
  }
