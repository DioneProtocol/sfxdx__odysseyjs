...
export const SelectInputClass = (inputid: number, ...args: any[]): Input => {
  if (inputid === OmegaVMConstants.SECPINPUTID) {
    return new SECPTransferInput(...args)
  } else if (inputid === OmegaVMConstants.STAKEABLELOCKINID) {
...
export class SECPTransferInput extends AmountInput {
  ...
  protected _typeID = OmegaVMConstants.SECPINPUTID
  ...
  getCredentialID = (): number => OmegaVMConstants.SECPCREDENTIAL
...
export class StakeableLockIn extends AmountInput {
  ...
  protected _typeID = OmegaVMConstants.STAKEABLELOCKINID
