 ...
 * @module API-OmegaVM-Transactions
 */
...
export const SelectTxClass = (txtype: number, ...args: any[]): BaseTx => {
  if (txtype === OmegaVMConstants.BASETX) {
    return new BaseTx(...args)
  } else if (txtype === OmegaVMConstants.IMPORTTX) {
    return new ImportTx(...args)
  } else if (txtype === OmegaVMConstants.EXPORTTX) {
    return new ExportTx(...args)
  } else if (txtype === OmegaVMConstants.ADDDELEGATORTX) {
    return new AddDelegatorTx(...args)
  } else if (txtype === OmegaVMConstants.ADDVALIDATORTX) {
    return new AddValidatorTx(...args)
  } else if (txtype === OmegaVMConstants.CREATESUBNETTX) {
    return new CreateSubnetTx(...args)
  } else if (txtype === OmegaVMConstants.ADDSUBNETVALIDATORTX) {
