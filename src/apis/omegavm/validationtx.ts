 ...
 * @module API-OmegaVM-ValidationTx
 */
...
export abstract class WeightedValidatorTx extends ValidatorTx {
   ...
   * @param weight Optional. The amount of nDIONE the validator is staking.
   */
  constructor(
...
export class AddDelegatorTx extends WeightedValidatorTx {
  ...
  protected _typeID = OmegaVMConstants.ADDDELEGATORTX
...
export class AddValidatorTx extends AddDelegatorTx {
  ...
  protected _typeID = OmegaVMConstants.ADDVALIDATORTX
