...
import { DELTAInput, SECPTransferInput, TransferableInput } from "./inputs"
import { Output } from "../../common/output"
import { UnixNow } from "../../utils/helperfunctions"
import { StandardUTXO, StandardUTXOSet } from "../../common/utxos"
import { OmegaChainID } from "../../utils/constants"
import {
...
export class UTXO extends StandardUTXO {
  ...
  create(
    codecID: number = DELTAConstants.LATESTCODEC,
...
export class UTXOSet extends StandardUTXOSet<UTXO> {
   ...
   * @param dioneAssetID {@link https://github.com/feross/buffer|Buffer} of the AssetID for DIONE
  ...
  buildExportTx = (
    ...
    if (typeof destinationChain === "undefined") {
      destinationChain = bintools.cb58Decode(OmegaChainID)
    }
