...
import { DELTAAPI, Tx } from "../../src/apis/delta"
...
const main = async (): Promise<any> => {
  ...
  const hex: string = await dchain.getAtomicTx(txID)
  ...
  const chainName = (item: string) => {
    ...
    const dchainID = "2q9e4r6Mu3U68nU1fYjgbR6JvwrRx36CohpAX5UQxse55x1Q5"
    const ochainID = "11111111111111111111111111111111LpoYY"
