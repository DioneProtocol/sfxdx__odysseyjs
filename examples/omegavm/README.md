...
Example scripts for the Odyssey [OmegaVM RPC](https://docs.dione.network/build/odysseygo-apis/omega-chain-p-chain-api)
...
* [exportTx-achain.ts](./exportTx-achain.ts)
...
* [importTx-achain.ts](./importTx-achain.ts)
* [JSONOChainTx.ts](./JSONOChainTx.ts)
