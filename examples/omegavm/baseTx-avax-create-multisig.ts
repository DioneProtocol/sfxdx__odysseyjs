...
pKeychain.importKey(privKey)
const xAddresses: Buffer[] = ochain.keyChain().getAddresses()
const xAddressStrings: string[] = ochain.keyChain().getAddressStrings()
...
const main = async (): Promise<any> => {
  ...
  const alphaUTXOResponse: any = await ochain.getUTXOs(xAddressStrings)
